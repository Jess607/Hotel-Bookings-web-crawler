...
class Booking_Ikoyi():
    ...
    def select_location(self):
        elems=self.driver.find_element(By.XPATH, '//form[@method="post"]//label[@for="147-ikoyi"]//span[1]')
